...
<body>
    ...
    <div class="header">
        ...
        <h3 style="text-transform: uppercase"> RECO LIGHTING <br> Purchase Invoice </h3>
        <a href="#" class="btn btn-primary" id="print">Update And Save</a>
        <a href="{{url('purchase')}}" class="btn btn-primary" id="save_btn"> Save</a>
    </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="total">{{$sum - $data[0]->discount}}</td>
                        @else
                        
                        <td class="total">{{$sum - $total_amount}}</td>
                        @endif
