                   ...
                   $sr++; 
                    ...
                    $grand_total += $total;
                     ...
                     <tr>
                        ...
                        <td class="light">{{$select_data->entry->name}}</td>
                        <td class="light">{{$select_data->bill_number}}</td>
                        <td class="light">{{$select_data->branch->name}}</td>
                        <td class="light">{{$select_data->qty}}</td>
                        <td class="light">{{$select_data->price}}</td>
                        <td class="light">{{$select_data->price}}</td>
                    </tr>
                    {{-- @php
                    $qty = $dat->qty;       
                    ...
                    {{-- @endphp --}}
                         ...
                         @php
                         $discount_amount = $grand_total*($dat->discount / 100);

                         if($dat->discount_type == "rupees"){
                           $total_amount =   $grand_total - $dat->discount;
                         }else{

                            $total_amount = $invoice_total - $grand_total;
                         }
