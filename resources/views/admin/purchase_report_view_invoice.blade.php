            ...
            <table>
                ...
                <tbody>
                    @php
                        ...
                        $discount_amount=0;
                    @endphp
                    @foreach ($data->unique('purchase_number') as $dat )
                    ...
                    $total = $qty*$price;
                     ...
                     $select = purchase::where(['purchase_number'=>$dat->purchase_number])->get();
                    ...
                    $invoice_total+= $total;
                         ...
                         $discount_amount = $invoice_total*($data[0]->discount / 100);

                         if($data[0]->discount_type == "rupees"){
                           $total_amount =   $invoice_total - $data[0]->discount;
                         }else{
