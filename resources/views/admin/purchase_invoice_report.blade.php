 ...
 <main role="main" class="main-content">
    <div class="container-fluid">
      ...
      'success'
          ...
          <form action="{{url('purchase_report_genrate')}}" method="POST" id="report_form">
            @csrf
            <div class="container-fluid">
              ...
              <div class="row mb-3 align-items-center" style="background: #fff">
                     ...
                     <div class="col-md-12">
                    <h4 class="text-center mb-4" style="border-bottom: 2px solid #000">Purchase Reported Genrated</h4>
                </div>
