            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach($select as $select_data){
                     ...
                     $product_price_a = price::where(['product_id'=>$select_data->product_id])->first();

                       $profit_amount = $product_price_a->a_price?$product_price_a->a_price : 0;
            ...
            <table>
                ...
                <tbody>
                    ...
                    @foreach ($data as $dat )
                       ...
                       @php
                       $a_sum=0;
                          $a_price = price::where(['product_id'=>$dat->product_id])->first();
            ...
            <table>
                ...
                <tbody>
                    @php
                        ...
                        $total_expense = 0;
                    @endphp
                    @forelse ($expense as $dat )


                    @php
                    $sr++;
                    $total_expense+= $dat->price;
                    @endphp

                    <tr>

                        <td class="light">{{$sr}}</td>
                        <td class="light">{{$dat->date}}</td>
                        <td class="light">{{$dat->description}}</td>
                        <td class="light">{{$dat->employee}}</td>
            ...
            <table>
                ...
                <tbody>
                    @php
                        ...
                        $total_salary = 0;
                    @endphp
                    @forelse ($salary as $dat )


                    @php
                    $sr++;
                    $total_salary+= $dat->salary;
                    @endphp

                    <tr>

                        <td class="light">{{$sr}}</td>
                        <td class="light">{{$dat->month}}</td>
                        <td class="light">{{$dat->branch->name}}</td>
                        <td class="light">{{$dat->employee->name}}</td>
                        <td class="light">{{$dat->salary}}</td>
                        <td class="light">{{$dat->salary}}</td>
                    ...
                    <tr>
                        ...
                        <td class="total">Salary total</td>
                        <td class="total">{{$total_salary}}</td>
        ...
        <div class="data" style="width: 50%; margin-left:0%;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    @php
                        $total_debit = $profit_amount_total + $total_salary +$total_expense;
                    @endphp
